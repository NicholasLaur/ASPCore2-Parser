...
/* parser.Parser.java */
/* Generated By:JavaCC: Do not edit this line. parser.Parser.java */
...
System.out.println("OK");
  ...
  static final public boolean rule() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CONS:{
...
System.out.println("OK atomo");
  ...
  static final public void classic_literal() throws ParseException {
    ...
    atom();
System.out.println("OK classic_literal()");
  }
  ...
  static final public void naf_literal() throws ParseException {
    if (jj_2_3(3)) {
      ...
      classic_literal();
System.out.println("Ok naf_literal()");
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ID:
      case SYMBOLIC_COSTANT:
...
System.out.println("ok variable_term()");
      break;
      }
    case ANON_VAR:{
  ...
  static final public void function_term() throws ParseException {
    ...
    terms();
    jj_consume_token(PARAM_CLOSE);
System.out.println("Ok function_term()");
  }
  ...
  static final public void predicate_name() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
      jj_consume_token(ID);
      break;
