...
if (jjtc000) {
  ...
  static final public void naf_aggregate_atom() throws ParseException {/*@bgen(jjtree) #Naf_Aggregate_atom(true) */
  ASPCore2Naf_Aggregate_atom jjtn000 = new ASPCore2Naf_Aggregate_atom(JJTNAF_AGGREGATE_ATOM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch (jj_nt.kind) {
...
if (jjtc000) {
  ...
  static final public void unequal_builtin_atom() throws ParseException {/*@bgen(jjtree) UnequalBuiltin_atom */
  ASPCore2UnequalBuiltin_atom jjtn000 = new ASPCore2UnequalBuiltin_atom(JJTUNEQUALBUILTIN_ATOM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      term();
  ...
  static private boolean jj_3_7()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0xf40b0120,0x10000,0xf40b0120,0xf4080120,0x8000,0x4803e0,0x800,0xf0000000,0xf0000000,0x4000,0x2000,0xf0000000,0x3c0000,0x4803f0,0xf0000000,0x4803e0,0x4803e0,0x4000,0x0,0x4803e0,0x400000,0x80000,0x800,0x10,0x4803e0,0x800,0x800,0x120,0x803c0,0x80000,0x80340,0x80,0x3c0000,0x80000,0x80080,0x4803c0,0x120,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x400,0x3,0x0,0x3,0x3,0x0,0x83c,0x0,0x3,0x3,0x0,0x0,0x3,0x0,0x83c,0x3,0x800,0x83c,0x0,0x3c,0x800,0x0,0x0,0x0,0x0,0x800,0x0,0x0,0x0,0x800,0x0,0x0,0x800,0x0,0x0,0x0,0x0,0x0,};
   }
